...
~~~
## OUTPUT:
<img width="1310" height="165" alt="image" src="https://github.com/user-attachments/assets/1981f871-4741-4b5f-9356-b1779b176f8a" />


## RESULT:

The host took 0.835534 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.038662 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
